...
<!-- Sección Dinámica de Proyectos -->
    <section  id="proyectos" class="projects-section">
        ...
        <div class="tarjeta-3d">
            ...
            <img src="{{ asset( $project->image_path) }}" alt="{{ $project->title }}" class="img-frontal">
            ...
            <model-viewer 
                src="{{ asset($project->modelo_3d_ruta) }}" 
                alt="Modelo 3D" 
                auto-rotate 
                camera-controls 
                class="modelo-fondo">
    ...
    @else
        ...
        <img src="{{ asset( $project->image_path) }}" alt="{{ $project->title }}" style="width: 100%; height: 300px; object-fit: cover; border-radius: 8px 8px 0 0;">
    @endif
